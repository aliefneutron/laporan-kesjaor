    ...
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 border-b border-gray-100 hover:bg-slate-50/50 transition-colors">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="w-20 text-center font-bold text-gray-800 border border-gray-200 rounded-lg py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:bg-gray-100 disabled:opacity-70 disabled:cursor-not-allowed"
        />
        <button
          type="button"
          disabled={isSubmitted}
